...
const Content = () =>{
    return <div style={content} >
        ...
        <h2>This tutorial doesn’t assume any existing React knowledge.</h2>
        <h3>What Are We Building?</h3>
        <div>In this tutorial, we’ll show how to build an interactive tic-tac-toe game with React.
